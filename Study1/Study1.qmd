...
par(mfrow = c(2, 2))
 ggplot(analysisA_data, aes(x = BPXOSY1)) +
...
ggplot(analysisA_data, aes(x = BPXOSY2)) +
 ...
 ggplot(analysisA_data, aes(x = "", y = BPXOSY1)) +
 ...
 ggplot(analysisA_data, aes(x = "", y = BPXOSY2)) +
...
```{r echo=TRUE, warning=FALSE, message=FALSE, fig.height=14}
